...
class ReportController extends MobiledetectController {
    ...
    public function actionPayment() {
        ...
        if (Yii::$app->request->getIsGet()) {
            ...
            switch ($submitMode) {
                case MasterValueUtils::SM_MODE_INPUT:
                    ...
                    $reportMonth = DateTimeUtils::parse($year . $month . '01', DateTimeUtils::FM_DEV_DATE);
        ...
        if (count($resultModel) > 0) {
            ...
            $renderData['arrDataChart'] = json_encode(['label'=>$arrLabelChart, 'credit'=>$arrCreditDataChart, 'debit'=>$arrDebitDataChart, 'balance'=>$arrBalanceDataChart], JSON_NUMERIC_CHECK);
            var_dump($renderData['arrDataChart']);
        }
