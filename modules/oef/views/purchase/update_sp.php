<?php
    ...
    $this->title = Yii::t('oef.purchase', 'Edit Purchase');
?>
...
<div class="row"><div class="col-md-12"><div class="box box-widget widget-detail">
    ...
    <div class="box-footer" id="oefPurchaseUpdateForm"><?php $form = ActiveForm::begin(['requiredCssClass' => 'form-group-required']); ?>
        ...
        <?= $form->field($model, 'purchase_type', ['inputOptions'=>['disabled'=>'disabled', 'name'=>'']])->dropDownList($arrPurchaseType, ['prompt'=>'']); ?>
